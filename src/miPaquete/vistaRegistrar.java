...
public class vistaRegistrar extends javax.swing.JFrame {
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
       ...
       if(!Controlador.verficarCodigo(codigo)){
           
            Controlador.registrarAlumno(codigo, nombre, carrera, semestre, promedio);
            mostrarMensajeEmergente("Registro", "Registro de Alumno exitoso!!!");
            }else{
           mostrarMensajeEmergente("Registro", "Codigo Repetido");
